...
import { Tooltip } from 'react-tooltip'
  ...
  import feedback from "../../assets/icons/linkIcons/feedback.svg"
        ...
        <div className="container">
          <div className="nav-block">
              <nav>
                ...
                <NavLink data-tooltip-id="nav-tooltip" data-tooltip-content="Отзывы"><img src={feedback} alt="feedback"/></NavLink>
